...
# object. 
#
# Two options are common to all queries, a dialect and a resolver. The dialect
# is used to render the query to SQL, and the resolver is... no longer used...
...
# these methods in your own resolver object to allow passing of arbitrary 
# objects for table and field names.
